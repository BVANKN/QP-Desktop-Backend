...
const { configuredExecutionMode, executionModeSchema, splitExecutionArguments } = await import('../src/modules/mcp/execution-mode.js');
...
test('desktop completion returns the acknowledged operation result', async () => {
  ...
  const context = {
    RESUMABLE_PLUGIN_TOOLS, operationContract, configuredExecutionMode, executionModeSchema, splitExecutionArguments,
