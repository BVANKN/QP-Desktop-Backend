      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              '  - If this creates a project, adds a dependency manifest, or will run an install/build,',
              '    call ensure_gitignore with mode "project" and apply true. Keep manifests and',
              '    lockfiles tracked; ignore downloaded dependencies, caches and generated output.',
              '',
              'VERIFY',
