...
export const MCP_TOOLS = Object.freeze([
  ...
  tool('add_model_app_table', 'addMdaTableComponent', 'Add a table to a model-driven app. Newly-created unpublished draft apps are supported; pass the AppModule ID returned by create_model_app and do not create or publish a replacement app.', object({ appModuleId: string('App module GUID.'), tableLogicalName: tableName, rootComponentBehavior: number('0 include subcomponents, 1 do not include, or 2 include shell only.') }, ['appModuleId', 'tableLogicalName']), { readOnly: false, idempotent: true }),
